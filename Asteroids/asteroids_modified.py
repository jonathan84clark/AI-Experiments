...
pygame.draw.polygon(SPACESHIP_IMAGE, WHITE, [(0, 0), (25, 15), (50, 0),(25, 50)])  # Rotated 90° left
...
class Spaceship:
    ...
    def get_front_position(self):
        front_x = self.x + math.cos(math.radians(self.angle))
        front_y = self.y + math.sin(math.radians(self.angle))
...
class Asteroid:
    def __init__(self, x=None, y=None, radius=None):
        ...
        self.radius = radius if radius is not None else random.randint(40, 60)
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN and spaceship.alive:
            if event.button == 1:  # Left mouse button
                ...
                bullets.append(Bullet(bullet_x, bullet_y, spaceship.angle + 90))
